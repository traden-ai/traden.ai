class Ledger:
    def __init__(self, balance: int, tradable_stocks: list):
    ...
    def buy(self, stock_name: str, stock_price: int, amount: int):
    ...
    def sell(self, stock_name: str, stock_price: int, amount: int):
